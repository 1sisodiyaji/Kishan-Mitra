...
<body  style=" margin: 0%;padding:0%;box-sizing: border-box;overflow-x: hidden; background: linear-gradient(90deg, rgba(44,70,82,1) 0%, rgba(171,217,194,1) 77%);">
    ...
    <!-- navbar -->
      ...
      ?>
        <section class=" container  mt-4 mb-5">
            <div class="container d-flex justify-content-evenly align-items-center w-full mb-4 mt-4 g-0">
                <div class="row">
                    <div class="col-lg-5 col-12 text-light">
                        <h2 class="text-dark text-center">Our vision :</h2>
            ...
            <div class=" container d-flex justify-content-evenly align-items-center w-full mb-4 mt-4 g-0">
                <div class="row d-flex flex-wrap-reverse ">
                    <div class="col-lg-7  col-12 g-0 img-fluid">
                        <img src="img/Approach.jpg" width="612"  height="408"  alt="Approach">
                    </div>
                    <div class="col-lg-5 col-12 text-light ">
                        <h2 class="text-dark text-center">Our Approach :</h2>
                        <br>
                        Our approach is rooted in empathy, understanding the unique challenges faced by farmers.
                        We integrate technology solutions that address their specific needs, making agriculture
                        more accessible and efficient. Co-Creation with Farmers:
                        <br>
                        Kishan-Mitra takes a collaborative approach by involving farmers in the co-creation process.
                        We believe in working hand-in-hand with the agricultural community to develop solutions that
                        truly meet their requirements. User-Centric Design:
                        <br>
                        The heart of our approach lies in designing user-centric solutions. We prioritize ease of use,
                        ensuring that our technology is accessible to farmers of all ages and backgrounds, fostering
                        widespread adoption.   Localized Knowledge Sharing:
                        <br>
                        Kishan-Mitra emphasizes the importance of localized knowledge sharing. We facilitate the exchange
                        of traditional farming wisdom alongside modern agricultural practices, creating a holistic learning environment.
                    </div>
                </div>
            </div>

            <div class=" container w-full mb-4 mt-4 g-0 d-flex justify-content-center align-item-center ">
                <div class="row d-flex  ">
                    <div class="col-lg-5  col-12 text-light">
                        <h2 class="text-dark text-center">Our Process :</h2>
                    ...
                    <div class="col-lg-7 col-12 g-0 img-fluid">
                        <img src="img/Process.jpg"  height="408" width="612" alt="Process">
                    </div>
                </div>
            </div>
        </section>
